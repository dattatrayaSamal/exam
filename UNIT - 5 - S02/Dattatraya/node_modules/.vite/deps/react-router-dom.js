...
var DataRouterContext = J(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = J(null);
DataRouterStateContext.displayName = "DataRouterState";
var ViewTransitionContext = J({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = J(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = J(null);
AwaitContext.displayName = "Await";
var NavigationContext = J(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = J(
  null
);
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator: navigator2 } = x2(NavigationContext);
...
function useInRouterContext() {
  return x2(LocationContext) != null;
}
function useLocation() {
  ...
  return x2(LocationContext).location;
}
function useNavigationType() {
  return x2(LocationContext).navigationType;
}
...
function useIsomorphicLayoutEffect(cb) {
  let isStatic = x2(NavigationContext).static;
  if (!isStatic) {
    _(cb);
  }
}
function useNavigate() {
  let { isDataRoute } = x2(RouteContext);
...
function useNavigateUnstable() {
  ...
  let dataRouterContext = x2(DataRouterContext);
  let { basename, navigator: navigator2 } = x2(NavigationContext);
  let { matches } = x2(RouteContext);
...
var OutletContext = J(null);
function useOutletContext() {
  return x2(OutletContext);
}
function useOutlet(context) {
  let outlet = x2(RouteContext).outlet;
  if (outlet) {
    return g(OutletContext.Provider, { value: context }, outlet);
  }
  return outlet;
}
function useParams() {
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  ...
  let { navigator: navigator2 } = x2(NavigationContext);
  let { matches: parentMatches } = x2(RouteContext);
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = g(k, null, g("p", null, "💿 Hey developer 👋"), g("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", g("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", g("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  }
  return g(k, null, g("h2", null, "Unexpected Application Error!"), g("h3", { style: { fontStyle: "italic" } }, message), stack ? g("pre", { style: preStyles }, stack) : null, devInfo);
}
var defaultErrorElement = g(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends x {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return this.state.error !== void 0 ? g(RouteContext.Provider, { value: this.props.routeContext }, g(
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return g(RouteContext.Provider, { value: routeContext }, children);
}
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => {
      ...
      if (error) {
        ...
        children = g(match.route.Component, null);
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? g(
      RenderErrorBoundary,
      {
...
function useDataRouterContext(hookName) {
  let ctx = x2(DataRouterContext);
  invariant(ctx, getDataRouterConsoleError(hookName));
  return ctx;
}
function useDataRouterState(hookName) {
  let state = x2(DataRouterStateContext);
  invariant(state, getDataRouterConsoleError(hookName));
  return state;
}
function useRouteContext(hookName) {
  let route = x2(RouteContext);
...
function useRouteError() {
  var _a;
  let error = x2(RouteErrorContext);
  let state = useDataRouterState(
    "useRouteError"
    /* UseRouteError */
  );
...
function mapRouteProperties(route) {
  ...
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: g(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: g(route.ErrorBoundary),
...
function RouterProvider({
  ...
  let [state, setStateImpl] = h(router2.state);
  ...
  _(() => router2.subscribe(setState), [router2, setState]);
  y(() => {
  ...
  return g(k, null, g(DataRouterContext.Provider, { value: dataRouterContext }, g(DataRouterStateContext.Provider, { value: state }, g(FetchersContext.Provider, { value: fetcherData.current }, g(ViewTransitionContext.Provider, { value: vtContext }, g(
    Router,
    {
      basename,
      location: state.location,
...
var MemoizedDataRoutes = M(DataRoutes);
function DataRoutes({
  routes,
  future,
  state
...
function Navigate({
  ...
  let { static: isStatic } = x2(NavigationContext);
  warning(
    !isStatic,
...
function Router({
  ...
  return g(NavigationContext.Provider, { value: navigationContext }, g(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location
...
function Await({
  ...
  return g(AwaitErrorBoundary, { resolve, errorElement }, g(ResolveAwait, null, children));
}
var AwaitErrorBoundary = class extends x {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) {
      return g(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1) {
      return g(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
...
function StreamTransfer({
  ...
  if (done) {
    ...
    return g(k, null, scriptTag, g(P, null, g(
      StreamTransfer,
      {
        context,
...
var RemixErrorBoundary = class extends x {
  constructor(props) {
    super(props);
...
function RemixRootDefaultErrorBoundary({
  ...
  if (isRouteErrorResponse(error)) {
    return g(BoundaryShell, { title: "Unhandled Thrown Response!" }, g("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), heyDeveloper);
  }
  let errorInstance;
  ...
  return g(
    ...
    g("h1", { style: { fontSize: "24px" } }, "Application Error"),
    g(
      "pre",
      {
        style: {
...
function BoundaryShell({
  ...
  return g("html", { lang: "en" }, g("head", null, g("meta", { charSet: "utf-8" }), g(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), g("title", null, title)), g("body", null, g("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children, renderScripts ? g(Scripts, null) : null)));
}
function RemixRootDefaultHydrateFallback() {
  return g(BoundaryShell, { title: "Loading...", renderScripts: true }, g(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => g(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component4 ? {
        element: g(routeModule.Layout, null, g(Component4, null))
      } : { Component: Component4 },
      ...ErrorBoundary ? {
        errorElement: g(routeModule.Layout, null, g(ErrorBoundary, null))
      } : { ErrorBoundary },
      ...HydrateFallback ? {
        hydrateFallbackElement: g(routeModule.Layout, null, g(HydrateFallback, null))
      } : { HydrateFallback }
    };
  }
...
function useDataRouterContext2() {
  let context = x2(DataRouterContext);
  invariant2(
    context,
...
function useDataRouterStateContext() {
  let context = x2(DataRouterStateContext);
  invariant2(
    context,
...
var FrameworkContext = J(void 0);
FrameworkContext.displayName = "FrameworkContext";
function useFrameworkContext() {
  let context = x2(FrameworkContext);
  invariant2(
    context,
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  let frameworkContext = x2(FrameworkContext);
  let [maybePrefetch, setMaybePrefetch] = h(false);
  let [shouldPrefetch, setShouldPrefetch] = h(false);
...
function Links() {
  ...
  return g(k, null, criticalCss ? g("style", { dangerouslySetInnerHTML: { __html: criticalCss } }) : null, keyedLinks.map(
    ({ key, link }) => isPageLinkDescriptor(link) ? g(PrefetchPageLinks, { key, ...link }) : g("link", { key, ...link })
  ));
}
function PrefetchPageLinks({
  ...
  return g(PrefetchPageLinksImpl, { page, matches, ...dataLinkProps });
}
function useKeyedPrefetchLinks(matches) {
  let { manifest, routeModules } = useFrameworkContext();
  let [keyedPrefetchLinks, setKeyedPrefetchLinks] = h([]);
  y(() => {
...
function PrefetchPageLinksImpl({
  ...
  return g(k, null, dataHrefs.map((href) => g("link", { key: href, rel: "prefetch", as: "fetch", href, ...linkProps })), moduleHrefs.map((href) => g("link", { key: href, rel: "modulepreload", href, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => (
...
function Meta() {
  ...
  return g(k, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return g(Comp, { key: JSON.stringify(rest), ...rest });
    }
    if ("title" in metaProps) {
      return g("title", { key: "title" }, String(metaProps.title));
    }
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? g("meta", { key: "charSet", charSet: metaProps.charSet }) : null;
    }
    ...
    return g("meta", { key: JSON.stringify(metaProps), ...metaProps });
  }));
}
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated ? null : g(k, null, !enableFogOfWar ? g(
    "link",
    {
      rel: "modulepreload",
      href: manifest.url,
...
var Link = D(
  function LinkWithRef({
    ...
    let { basename } = x2(NavigationContext);
    ...
    return shouldPrefetch && !isAbsolute ? g(k, null, link, g(PrefetchPageLinks, { page: href })) : link;
  }
);
...
var NavLink = D(
  function NavLinkWithRef({
    ...
    let location = useLocation();
    let routerState = x2(DataRouterStateContext);
    let { navigator: navigator2, basename } = x2(NavigationContext);
...
function ScrollRestoration({
  ...
  let remixContext = x2(FrameworkContext);
  let { basename } = x2(NavigationContext);
  let location = useLocation();
...
function useFormAction(action, { relative } = {}) {
  let { basename } = x2(NavigationContext);
  let routeContext = x2(RouteContext);
...
function useFetcher({
  ...
  let fetcherData = x2(FetchersContext);
  let route = x2(RouteContext);
  ...
  let FetcherForm = T(() => {
    let FetcherForm2 = D(
      (props, ref) => {
        return g(Form, { ...props, navigate: false, fetcherKey, ref });
      }
    );
...
function useViewTransitionState(to, opts = {}) {
  let vtContext = x2(ViewTransitionContext);
  invariant(
    vtContext != null,
...
function StaticRouterProvider({
  ...
  return g(k, null, g(DataRouterContext.Provider, { value: dataRouterContext }, g(DataRouterStateContext.Provider, { value: state }, g(FetchersContext.Provider, { value: fetchersContext }, g(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, g(
    Router,
    {
...
function ServerRouter({
  ...
  return g(k, null, g(
    ...
    g(RemixErrorBoundary, { location: router2.state.location }, g(
  ...
  ), context.serverHandoffStream ? g(P, null, g(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
function createRoutesStub(routes, context = {}) {
  return function RoutesTestStub({
    ...
    return g(FrameworkContext.Provider, { value: remixContextRef.current }, g(RouterProvider, { router: routerRef.current }));
  };
}
...
function RouterProvider2(props) {
  return g(RouterProvider, { flushSync: En, ...props });
}
var ssrInfo = null;
var router = null;
...
function HydratedRouter() {
  ...
  let [criticalCss, setCriticalCss] = h(
  ...
  let [location, setLocation] = h(router.state.location);
  _(() => {
  ...
  return (
    ...
    g(k, null, g(
      ...
      g(RemixErrorBoundary, { location }, g(RouterProvider2, { router }))
    ), g(k, null))
  );
}
export {
